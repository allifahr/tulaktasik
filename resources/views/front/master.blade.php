...
<header id="header" class="hidden-xs">
	<div class="topbar">
		<div class="container">
			<div class="row">
				<div class="col-sm-6"><div class="tollNum">Hubungi Kami : +628 888 8888</div></div>
				<div class="col-sm-6">
					...
					<div class="account-link ">
						...
						<ul>
							@if(Auth::check())
							<li><a href="{{url('/inbox')}}" >KOTAK MASUK(0)</a></li>
							<li><a href="{{url('/home')}}">AKUN SAYA</a></li>
    ...
    <div class="container">
    	<div class="row">
    		<div class="col-sm-2">
				<div class="logow" >
						<a href="{{url('/')}}" class="logow-container"><img src="{{ URL::asset('img/logo2.png') }}" /></a></div></div>
    		<div class="col-sm-8">
				<div class="nav-link">
					<ul>
				...
				<div class="nav-btns">
					<div class="nav-cart">
						<a href="{{url('cart')}}"><img src="{{ asset('img/cart.png')}}"/>
						 <b style="color: #ffffff">CART({{Cart::count()}})</b>
					 </a>
					</div>
				</div>
		    </div>
...
<footer id="footer">
  <div class="container">
      ...
      <div class="col-sm-12">
        ...
        <div class="col-sm-5 col-lg-4">
          ...
          <div class="newsletter">
            <p>Masukkan email untuk mendapatkan informasi terbaru</p>
            <div class="input-group">
              <input type="text" class="form-control" placeholder="masukkan email...">
              <span class="input-group-btn">
                <input type="submit" class="btn btn-default" type="button" Value="Langganan" />
              </span>
            </div>
            <ul class="social">
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="copyrt">
          &copy; 2018 Tulaktasik.id . All Rights Reserved. <a href="terms-conditions.php">Terms &amp; Conditions</a>
        </div>
      </div>
    </div>
  </div>
