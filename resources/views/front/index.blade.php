				...
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-4 text-center">
							...
							<div class="col-text">Anda dapat belanja products TulakTasik dimana saja dan kapan saja.</div>
						</div>
						<div class="col-sm-4 text-center">
            ...
            <div id="hdLine"><span><h1>Produk Kami</h1></span><hr></div><br>
			   ...
			   <div class="row">
       			<div class="col-xs-6 col-sm-4">
	    			<div class="itemBox bdr">
	    				...
	    				<span class="hidden-xs">Tutug oncom instan Arenda terbuat dari oncom super pilih, diproductssi dengan bumbu alami tanpa MSG dan pengawet.</span>
	    				<div class="addcart">
       		...
       		<div class="row">
       			...
       			<div class="col-sm-4 text-center">
       				...
       				<div class="helpText">Jika anda ingin return silahkan hubungi Customer Service kami.</div>
       			</div>
       		</div>
        </div>
    </div>
