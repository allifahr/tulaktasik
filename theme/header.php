...
<header id="header" class="hidden-xs">
    ...
    <div class="container">
    	<div class="row">
		<div class="col-sm-2"><div class="logow" ><a href="index.php"
			class="logow-container"><img src="images/logo2.png" /></a></div></div>
    		<div class="col-sm-8">
				<div class="nav-link">
					<ul>
		    ...
		    <div class="col-sm-2">
				<div class="nav-btns">
					<div class="nav-cart">
						<img src="{{URL:: asset('img/cart.png')}}"/> CART(0)
					</div>
				</div>
		    </div>
		</div>
...
<header id="header" class=" hidden-sm hidden-md hidden-lg">
	...
	<div class="logow" ><a href="index.php"><img src="images/logo2.png" alt=""  /></a></div>
	<div class="m-cart">
		<div class="nav-btns">
			<div class="nav-cart">
